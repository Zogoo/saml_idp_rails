...
module SamlIdpRails
  class SamlIdpControllerTest < ActionDispatch::IntegrationTest
    ...
    setup do
      @sp_config = saml_idp_rails_saml_sp_configs(:one)
    ...
    test "should store authn request for unsigned user" do
      ...
      assert_redirected_to SamlIdpRails.config.sign_in_url
    ...
    #   SamlIdpRails::SamlIdpController.any_instance.stubs(:user_signed_in?).returns(true)
    #   SamlIdpRails::SamlIdpController.any_instance.expects(:encode_authn_response)
