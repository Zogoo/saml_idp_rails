...
module SamlIdpRails
  class SamlConfigTest < ActiveSupport::TestCase
    ...
    setup do
      ...
      @saml_config = SamlIdpRails::SamlConfig.new(@sp_config, @user)
    end
    ...
    test "should configure saml_idp" do
      ...
      assert_equal SamlIdpRails.config.base_url, config.organization_name
      assert_equal SamlIdpRails.config.base_url, config.organization_url
    end
